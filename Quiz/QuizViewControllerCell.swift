...
//  MyQuizApp
//
//  Created by Ognjen Milovanovic on 05.08.20.
...
class QuizViewControllerCell: UICollectionViewCell {
    ...
    var question: QuestionViewModel? {
        didSet {
            ...
            //hier wird unterschieden ob die frage multiple-Choice oder true-false ist und ob nur zwei //knopfe angezeigt werden
            
            if(notAnsweredQuestion.type == "multiple"){
                if(button3.isHidden == true && button4.isHidden == true){
